...
go to the deployment descriptor which is named web.xml and change the implemented code as follows. this will make <strong>index.jsp</strong> the first page (if users have logged in)
```
