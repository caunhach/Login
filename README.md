...
go to the deployment descriptor which is named web.xml and change the implemented code as follows. this will make index.jsp the first page (if users are new or logged out)
```
